  ...
  return (
    <Page>
      <div className="flex flex-col gap-4">
        ...
        >
          <p>
            A proof of concept method for inferring Typescript types from a
            string literal containing raw SQL.
          </p>
          <p>
            It is assuming database introspection was used to create a generated
            Typescript type that corresponds to the database's schema.
          </p>
          <p>
